 ...
 */
  ...
  */
 public class RandomWorkloadSetup {
     ...
     public static void main(String[] args) {
        ...
        if (args.length != 1) {
            System.out.println("Usage: java RandomWorkloadSetup <numHosts> <maxVmsPerHost> <numCloudlets> <maxCloudletLength> <maxCloudletMemory> <maxCloudletCpus>");
            System.exit(1);
        }
        int numHosts = Integer.parseInt(args[0]);
        int maxVmsPerHost = Integer.parseInt(args[1]);
        int numCloudlets = Integer.parseInt(args[2]);
        int maxCloudletLength = Integer.parseInt(args[3]);
        int maxCloudletMemory = Integer.parseInt(args[4]);
        int maxCloudletCpus = Integer.parseInt(args[5]);
