 ...
 */
public class PowerVmAllocationPolicyDeterministic extends PowerVmAllocationPolicyAbstract {
	 ...
	 * @param list the list
	 */
	public PowerVmAllocationPolicyDeterministic(List<? extends Host> list) {
		super(list);
	}
	...
	/**
	 * Returns the host at the index specified by the VM
	 * 
